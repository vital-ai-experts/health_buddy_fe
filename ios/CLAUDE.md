...
HealthBuddy is an intelligent health management iOS app built with SwiftUI and Swift Package Manager (SPM). The app follows a strict layered architecture with clean separation of concerns.
